...
/* LGE_CHANGE_S: [2014-10-30] jeongjoo.lee@lge.com */
/* Comment: In order to use the LED should change LED mode and sets a PMIC's ISINK(0) */
    {"red",               MT65XX_LED_MODE_PMIC, MT65XX_LED_PMIC_NLED_ISINK0 ,{0}},
    {"green",             MT65XX_LED_MODE_NONE, -1,{0}},
    {"blue",              MT65XX_LED_MODE_NONE, -1,{0}},
/* LGE_CHANGE_E: [2014-10-30] jeongjoo.lee@lge.com */
